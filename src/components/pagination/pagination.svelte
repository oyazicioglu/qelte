...
<div {id} bind:this={ref} class="qei-pagination fullWidth">
    <Paper color="default" class="p-6">
        <Flex direction="row" {justifyContent} alignItems="center" gap={4}>
            ...
            <div class="spacer" />
            <IconButton on:click={previousPage} disabled={!previousArrowEnabled} circle icon={ChevronLeft} />
            <IconButton on:click={nextPage} disabled={!nextArrowEnabled} circle icon={ChevronRight} />
        </Flex>
    </Paper>
</div>
