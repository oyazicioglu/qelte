<script lang="ts">
    ...
    import type { BaseColor, BaseSize, ButtonType, FlexAlignItem, FlexDirection, FlexGap, FlexJustify, IconSize } from '../types.js';
...
<div
    ...
    <Flex {gap} direction="column">
        <TextInput
            ...
            {label}>
            <IconButton on:click={toggleShowList} {disabled} {size} {color} icon={showList ? ChevronDown : ChevronUp} />
        </TextInput>
    </Flex>
    {#if showList}
        <div
